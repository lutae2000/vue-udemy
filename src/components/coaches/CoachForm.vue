<template>
  <form @submit.prevent="submitForm()">
    ...
    <div class="form-control" :class="{invalid : !description.isValid}">
      ...
      <textarea type="description" rows="5" v-model="description.val" @blur="clearValidity('description')"></textarea>
    ...
    <div class="form-control" :class="{invalid : !rate.isValid}">
      ...
      <p v-if="!rate.isValid">rate must not be empty, it must be greater than 0</p>
    </div>
